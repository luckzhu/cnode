<template>
  <div>
    <div id="standings">
      <div class="avatar">
        <div class="topStandings" v-for="author in topAuthor" :key="author.id">
          <router-link :to="`/pc/user/${author.loginname}`"
...
let topAuthor = [
  ...
  {
    id: 8,
    avatar_url: " https://avatars1.githubusercontent.com/u/5300023?v=4&s=120",
    loginname: "DevinXian"
  },
  {
    id: 9,
